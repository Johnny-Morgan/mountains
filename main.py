...
class Main(QMainWindow):
    ...
    def layouts(self):
        ...
        self.statistics_right_layout.addRow("Total Hikes: ", self.total_hikes_label)
        ...
        self.statistics_right_layout.addRow("Average Speed: ", self.avg_speed_label)
...
class DisplayMountain(QWidget):
    ...
    def layouts(self):
        ...
        self.middle_left.addRow(QLabel("Height (m):"), self.height_entry)
        self.middle_left.addRow(QLabel("Prominence (m):"), self.prominence_entry)
...
class DisplayHike(QWidget):
    ...
    def layouts(self):
        ...
        self.top_frame.setLayout(self.top_layout)
        self.middle_left.addRow(QLabel("Length (km):"), self.length_entry)
        self.middle_left.addRow(QLabel("Duration:"), self.duration_entry)
        self.middle_left.addRow(QLabel("Ascent (m):"), self.ascent_entry)
        self.middle_left.addRow(QLabel("Descent (m):"), self.descent_entry)
